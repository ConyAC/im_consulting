...
import cl.koritsu.im.services.UserService;
			...
			public void buttonClick(ClickEvent event) {
				 ...
				 if (username.isEmpty() || password.isEmpty()) {
					 ...
					 try {
						 ...
						 if(user == null )throw new RuntimeException("Error en logn");
						 ...
						 if(user!= null) {
					 	 ...
					 	 signin.removeShortcutListener(enter);
		                    ...
		                    ((ImUI) UI.getCurrent()).updateContent();
...
//					 	 ValuedEventBus.post(new UserLoginRequestedEvent(username.getValue(), password.getValue()));
    ...
    private Component buildLabels() {
        ...
        Label title = new Label("COEVOLUTION IM CONSULTING");
	...
	public void enter(ViewChangeEvent event) {
		...
		((ImUI)UI.getCurrent()).setVisible(true);
		//re asigna el enter
